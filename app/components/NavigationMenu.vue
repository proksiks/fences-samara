<template>
  ...
  <div class="mobile-menu fixed top-0 left-0 bottom-0 z-40 w-full bg-white flex flex-col py-10 px-6 overflow-auto lg:hidden" :class="{ _active: showMenu }">
