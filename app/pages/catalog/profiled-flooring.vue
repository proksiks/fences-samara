        ...
        <lazy-sections-features-catalog image="/images/pages/catalog/profiled-flooring/2.png">
          ...
          <ul class="mt-6">
            <li class="relative pl-6 mt-3 text-gray-150 text-lg">
              ...
              <span class="text-green-105 font-medium">Долговечность:</span> Забор из профнастила с металлическими столбами устойчив к коррозии, погодным условиям и
              механическим повреждениям.
            </li>
            <li class="relative pl-6 mt-3 text-gray-150 text-lg">
              <span class="absolute w-1.5 h-1.5 rounded-full bg-green-105 top-2.5 left-1"></span>
              <span class="text-green-105 font-medium">Эстетика:</span> Широкая цветовая палитра позволит выбрать любой оттенок на ваш вкус.
            </li>
            <li class="relative pl-6 mt-3 text-gray-150 text-lg">
              <span class="absolute w-1.5 h-1.5 rounded-full bg-green-105 top-2.5 left-1"></span>
              <span class="text-green-105 font-medium">Цена:</span> Забор из профлиста – оптимальный выбор для бюджета, баланс цены и качества с прозрачным расчетом
              стоимости.
            </li>
            <li class="relative pl-6 mt-3 text-gray-150 text-lg">
              <span class="absolute w-1.5 h-1.5 rounded-full bg-green-105 top-2.5 left-1"></span>
              <span class="text-green-105 font-medium">Быстрая установка:</span> Монтаж забора из профлиста выполняется в кратчайшие сроки, обычно до 3 дней.
            </li>
          </ul>
